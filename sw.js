const CACHE="vo2-breathe-v7-2";
const ASSETS=["./","./index.html","./styles-v7-2.css?v=7.2.0","./app-v7-2.js?v=7.2.0","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
