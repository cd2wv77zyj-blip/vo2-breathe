const CACHE="vo2-breathe-v7-4";
const ASSETS=["./","./index.html","./styles-v7-4.css?v=7.4.0","./app-v7-4.js?v=7.4.0","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
