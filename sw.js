const CACHE="vo2-breathe-v7-6";
const ASSETS=["./","./index.html","./styles-v7-6.css?v=7.6.0","./app-v7-6.js?v=7.6.0","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
