const CACHE="vo2-breathe-v7-5";
const ASSETS=["./","./index.html","./styles-v7-5.css?v=7.5.0","./app-v7-5.js?v=7.5.0","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
