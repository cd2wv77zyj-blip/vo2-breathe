const CACHE="vo2-breathe-v7-3";
const ASSETS=["./","./index.html","./styles-v7-3.css?v=7.3.0","./app-v7-3.js?v=7.3.0","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
